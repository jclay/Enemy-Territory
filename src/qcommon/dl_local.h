...
int Com_VPrintf(const char* fmt, va_list pArgs)
...
void Com_Error(int code, const char* fmt, ...) _attribute(
    (format(printf, 2, 3)));  // watch out, we don't define ERR_FATAL and stuff
