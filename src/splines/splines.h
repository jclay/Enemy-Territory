...
extern void glLabeledPoint(idVec3& color,
                           idVec3& point,
                           float size,
                           const char* label);
...
class idPointListInterface {
 public:
  ...
  void deselectAll() { selectedPoints.Clear(); }
...
class idSplineList {
 public:
  ...
  bool validTime() {
    ...
    // why?  I've no idea...
    return (bool)(splineTime.Num() > 0 &&
                  splineTime.Num() == splinePoints.Num());
  }
