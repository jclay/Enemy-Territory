...
ID_INLINE mat3_t::mat3_t(const float xx,
                         const float xy,
                         const float xz,
                         const float yx,
                         const float yy,
...
ID_INLINE mat3_t mat3_t::operator*(const mat3_t& a) const {
  return mat3_t(mat[0].x * a[0].x + mat[0].y * a[1].x + mat[0].z * a[2].x,
...
ID_INLINE mat3_t mat3_t::operator*(float a) const {
  return mat3_t(mat[0].x * a, mat[0].y * a, mat[0].z * a, mat[1].x * a,
                mat[1].y * a, mat[1].z * a, mat[2].x * a, mat[2].y * a,
                mat[2].z * a);
}

ID_INLINE mat3_t mat3_t::operator+(mat3_t const& a) const {
  return mat3_t(mat[0].x + a[0].x, mat[0].y + a[0].y, mat[0].z + a[0].z,
...
ID_INLINE mat3_t operator*(float a, mat3_t const& b) {
  return mat3_t(b[0].x * a, b[0].y * a, b[0].z * a, b[1].x * a, b[1].y * a,
                b[1].z * a, b[2].x * a, b[2].y * a, b[2].z * a);
}
