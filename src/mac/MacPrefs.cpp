...
// CreateDefaultPrefs
//
// This routine sets up the default prefs, which are used either if this is the
// first time being run, or for some reason the prefs cannot be loaded. It is
// called by LoadPrefs and is internal to this file.
...
//  LoadPrefs
//
//  Loads the prefs from disk into the structure passed into the routine. If the
//  prefs cannot be loaded or they are being created from scratch, it sets them
//  to defaults.
// ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
...
void LoadPrefs(PrefsRec* thePrefs) {
  ...
  if (rsrc) {
    ...
    memcpy(thePrefs->serial, (**((PrefsRec**)rsrc)).serial,
           sizeof(thePrefs->serial));
...
//  SavePrefs
//
//  Writes the prefs to disk from the structure passed into the routine. If
//  there is a failure, nothing gets written and no warning is given or
//  returned.
// ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
...
void SavePrefs(PrefsRec* thePrefs) {
  ...
  if (rsrc) {
    ...
    memcpy((**((PrefsRec**)rsrc)).serial, thePrefs->serial,
           sizeof(thePrefs->serial));
