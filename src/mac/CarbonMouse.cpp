...
#define MAX_BUTTONS \
  32  // Carbon events supports up to 65536 buttons,
...
//
//  Caveats: mouse deltas are only supported under X so far. Also, under Carbon
//  9 pressing any mouse button returns a button value of 1, e.g. the main mouse
//  button
// ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
static pascal OSStatus appMouseEventHandler(EventHandlerCallRef myHandler,
                                            EventRef event,
                                            void* userData) {
#pragma unused(myHandler, userData)
...
#if MAC_Q3
  // MLTE handles some mouse events, so we pass them along if the console is
  // frontmost
  ...
  switch (eventKind) {
    ...
    case kEventMouseDragged: {
      ...
      result = GetEventParameter(event, kEventParamMouseDelta, typeQDPoint,
                                 NULL, sizeof(mouseDelta), NULL, &mouseDelta);
    ...
    case kEventMouseDown: {
      (void)GetEventParameter(event, kEventParamMouseButton, typeMouseButton,
                              NULL, sizeof(theButton), NULL, &theButton);
...
Boolean Carbon_InitMouse(void) {
  ...
  EventTypeSpec list[] = {
      ...
      {kEventClassMouse,
       kEventMouseDragged},  // deltas while mouse button is down
  ...
  status =
      InstallApplicationEventHandler(sMouseEventHandlerUPP, 5, list, 0, &ref);
...
// ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
//  Effectively polls the mouse delta values as set by the Carbon event
//  handlers. It also resets them so that the delta states accurately represent
//  the delta since the last time this routine was called.
// ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
...
void Carbon_EnableMouse(Boolean inState) {
  ...
  if (inState) {
    ...
    // FIXME: this is hosed when you're running in a window .. that stuff is
