...
typedef struct {
  ...
  Boolean button2fake;  // True if we turn ctrl-clicks into second mouse button
                        // clicks
...
#define rPrefsVersion \
  1112  // IMPORTANT - increment this each time the PrefsRec changes
