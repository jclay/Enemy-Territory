...
void(APIENTRY* qglColor4b)(GLbyte red,
                           GLbyte green,
                           GLbyte blue,
                           GLbyte alpha) = NULL;
...
void(APIENTRY* qglEdgeFlagPointer)(GLsizei stride,
                                   const GLboolean* pointer) = NULL;
...
void(APIENTRY* qglFeedbackBuffer)(GLsizei size,
                                  GLenum type,
                                  GLfloat* buffer) = NULL;
...
void(APIENTRY* qglGetLightfv)(GLenum light,
                              GLenum pname,
                              GLfloat* params) = NULL;
...
void(APIENTRY* qglGetMaterialfv)(GLenum face,
                                 GLenum pname,
                                 GLfloat* params) = NULL;
void(APIENTRY* qglGetMaterialiv)(GLenum face,
                                 GLenum pname,
                                 GLint* params) = NULL;
...
void(APIENTRY* qglGetTexEnvfv)(GLenum target,
                               GLenum pname,
                               GLfloat* params) = NULL;
void(APIENTRY* qglGetTexEnviv)(GLenum target,
                               GLenum pname,
                               GLint* params) = NULL;
void(APIENTRY* qglGetTexGendv)(GLenum coord,
                               GLenum pname,
                               GLdouble* params) = NULL;
void(APIENTRY* qglGetTexGenfv)(GLenum coord,
                               GLenum pname,
                               GLfloat* params) = NULL;
void(APIENTRY* qglGetTexGeniv)(GLenum coord,
                               GLenum pname,
                               GLint* params) = NULL;
...
void(APIENTRY* qglLightfv)(GLenum light,
                           GLenum pname,
                           const GLfloat* params) = NULL;
void(APIENTRY* qglLighti)(GLenum light, GLenum pname, GLint param) = NULL;
void(APIENTRY* qglLightiv)(GLenum light,
                           GLenum pname,
                           const GLint* params) = NULL;
...
void(APIENTRY* qglMaterialfv)(GLenum face,
                              GLenum pname,
                              const GLfloat* params) = NULL;
void(APIENTRY* qglMateriali)(GLenum face, GLenum pname, GLint param) = NULL;
void(APIENTRY* qglMaterialiv)(GLenum face,
                              GLenum pname,
                              const GLint* params) = NULL;
...
void(APIENTRY* qglPixelMapuiv)(GLenum map,
                               GLsizei mapsize,
                               const GLuint* values) = NULL;
void(APIENTRY* qglPixelMapusv)(GLenum map,
                               GLsizei mapsize,
                               const GLushort* values) = NULL;
...
void(APIENTRY* qglPrioritizeTextures)(GLsizei n,
                                      const GLuint* textures,
                                      const GLclampf* priorities) = NULL;
...
void(APIENTRY* qglRasterPos4d)(GLdouble x,
                               GLdouble y,
                               GLdouble z,
                               GLdouble w) = NULL;
void(APIENTRY* qglRasterPos4dv)(const GLdouble* v) = NULL;
void(APIENTRY* qglRasterPos4f)(GLfloat x,
                               GLfloat y,
                               GLfloat z,
                               GLfloat w) = NULL;
...
void(APIENTRY* qglRasterPos4s)(GLshort x,
                               GLshort y,
                               GLshort z,
                               GLshort w) = NULL;
...
void(APIENTRY* qglReadPixels)(GLint x,
                              ...
                              GLenum type,
                              GLvoid* pixels) = NULL;
void(APIENTRY* qglRectd)(GLdouble x1,
                         GLdouble y1,
                         GLdouble x2,
                         GLdouble y2) = NULL;
...
void(APIENTRY* qglTexCoord4d)(GLdouble s,
                              GLdouble t,
                              GLdouble r,
                              GLdouble q) = NULL;
void(APIENTRY* qglTexCoord4dv)(const GLdouble* v) = NULL;
void(APIENTRY* qglTexCoord4f)(GLfloat s,
                              GLfloat t,
                              GLfloat r,
                              GLfloat q) = NULL;
...
void(APIENTRY* qglTexCoord4s)(GLshort s,
                              GLshort t,
                              GLshort r,
                              GLshort q) = NULL;
...
void(APIENTRY* qglTexImage2D)(GLenum target,
                              ...
                              GLenum type,
                              const GLvoid* pixels) = NULL;
void(APIENTRY* qglTexParameterf)(GLenum target,
                                 GLenum pname,
                                 GLfloat param) = NULL;
void(APIENTRY* qglTexParameterfv)(GLenum target,
                                  GLenum pname,
                                  const GLfloat* params) = NULL;
void(APIENTRY* qglTexParameteri)(GLenum target,
                                 GLenum pname,
                                 GLint param) = NULL;
...
void(APIENTRY* qglVertex4d)(GLdouble x,
                            GLdouble y,
                            GLdouble z,
                            GLdouble w) = NULL;
...
void(APIENTRY* qglVertexPointer)(GLint size,
                                 ...
                                 GLsizei stride,
                                 const GLvoid* pointer) = NULL;
void(APIENTRY* qglViewport)(GLint x,
                            GLint y,
                            GLsizei width,
                            GLsizei height) = NULL;
