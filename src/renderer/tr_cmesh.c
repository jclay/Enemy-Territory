...
//
// This is ripped from tr_mesh.c, and converted to use the compressed mesh
// format
...
static int R_ComputeLOD(trRefEntity_t* ent) {
  ...
  if (tr.currentModel->numLods < 2) {
    ...
    frame = (md3Frame_t*)(((unsigned char*)tr.currentModel->model.mdc[0]) +
                          tr.currentModel->model.mdc[0]->ofsFrames);
