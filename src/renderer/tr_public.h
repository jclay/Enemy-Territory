...
typedef struct {
  ...
  qboolean (*GetSkinModel)(qhandle_t skinid,
                           const char* type,
                           char* name);  //----(SA)	added
  qhandle_t (*GetShaderFromModel)(qhandle_t modelid,
                                  int surfnum,
  ...
  int (*LightForPoint)(vec3_t point,
                       vec3_t ambientLight,
                       vec3_t directedLight,
                       vec3_t lightDir);
  void (*AddPolyToScene)(qhandle_t hShader,
                         int numVerts,
                         const polyVert_t* verts);
  // Ridah
  void (*AddPolysToScene)(qhandle_t hShader,
                          int numVerts,
                          const polyVert_t* verts,
                          int numPolys);
  // done.
  void (*AddLightToScene)(const vec3_t org,
                          float radius,
                          float intensity,
                          float r,
                          float g,
                          ...
                          int flags);
  //----(SA)
  void (*AddCoronaToScene)(const vec3_t org,
                           float r,
                           float g,
                           float b,
                           float scale,
  ...
  void (*DrawStretchPicGradient)(float x,
                                 float y,
                                 float w,
                                 float h,
                                 float s1,
  ...
  int (*MarkFragments)(int numPoints,
                       const vec3_t* points,
  ...
  void (*ProjectDecal)(qhandle_t hShader,
                       int numPoints,
                       vec3_t* points,
                       vec4_t projection,
                       vec4_t color,
  ...
  void (*SetGlobalFog)(qboolean restore,
                       int duration,
                       float r,
                       float g,
                       float b,
...
typedef struct {
  ...
  void (*CM_DrawDebugSurface)(void (*drawPoly)(int color,
                                               int numPoints,
                                               float* points));
  ...
  char** (*FS_ListFiles)(const char* name,
  ...
  int (*CIN_PlayCinematic)(const char* arg0,
                           int xpos,
                           int ypos,
                           int width,
                           int height,
