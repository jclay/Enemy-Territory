...
void Q1_AllocMaxBSP(void) {
  ...
  q1_texdatasize = 0;
  q1_dtexdata =
      (byte*)GetMemory(Q1_MAX_MAP_MIPTEX * sizeof(byte));  // (dmiptexlump_t)
  ...
  q1_numclipnodes = 0;
  q1_dclipnodes =
      (q1_dclipnode_t*)GetMemory(Q1_MAX_MAP_CLIPNODES * sizeof(q1_dclipnode_t));
  ...
  q1_dmarksurfaces = (unsigned short*)GetMemory(Q1_MAX_MAP_MARKSURFACES *
...
void Q1_LoadBSPFile(char* filename, int offset, int length) {
  ...
  q1_nummarksurfaces = Q1_CopyLump(Q1_LUMP_MARKSURFACES, q1_dmarksurfaces,
                                   sizeof(q1_dmarksurfaces[0]));
  q1_numsurfedges =
