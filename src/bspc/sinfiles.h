...
#define SURF_RICOCHET \
  0x800  // projectiles bounce literally bounce off this surface
#define SURF_PRELIT \
  0x1000  // surface has intensity information for pre-lighting
...
#define SURF_RANDOMANIMATE \
  0x400000                         // surface start animating on a random frame
...
#define SURF_TYPE_SHIFT(x) \
  ((x) << (SURF_START_BIT))  // macro for getting proper bit mask
