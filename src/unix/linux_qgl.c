...
// #include <GL/fxmesa.h>
// #endif
// #include <GL/glx.h> // bk010216 - FIXME: all of the above redundant?
// renderer/qgl.h
...
#if defined(__FX__)
// FX Mesa Functions
fxMesaContext (*qfxMesaCreateContext)(GLuint win,
                                      GrScreenResolution_t,
                                      GrScreenRefresh_t,
                                      const GLint attribList[]);
fxMesaContext (*qfxMesaCreateBestContext)(GLuint win,
                                          GLint width,
                                          GLint height,
                                          const GLint attribList[]);
...
GLXContext (*qglXCreateContext)(Display* dpy,
                                XVisualInfo* vis,
                                GLXContext shareList,
                                Bool direct);
void (*qglXDestroyContext)(Display* dpy, GLXContext ctx);
Bool (*qglXMakeCurrent)(Display* dpy, GLXDrawable drawable, GLXContext ctx);
void (*qglXCopyContext)(Display* dpy,
                        GLXContext src,
                        GLXContext dst,
                        GLuint mask);
...
// bk001129 - from cvs1.17 (mkv)
  ...
  qglXUseXFont = GPA("glXUseXFont");
  qglXSwapIntervalSGI = GPA("glXSwapIntervalSGI");
  qglXGetVideoSyncSGI = GPA("glXGetVideoSyncSGI");
  qglXWaitVideoSyncSGI = GPA("glXWaitVideoSyncSGI");
  qglXQueryExtensionsString = GPA("glXQueryExtensionsString");
