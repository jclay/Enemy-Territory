...
// reloadTime		-	time from start of reload until ready to fire.
// [4] = fireDelayTime	-	time from pressing 'fire' until first shot is
...
// something) maxclip2			-	allow the player to
// (mod/powerup) upgrade clip size when aplicable (luger has 8 round standard
// clip and 32 round snail magazine, for ex.)
//
//
//
...
ammotable_t ammoTableMP[WP_NUM_WEAPONS] = {
    ...
    //RELOAD	FIRE			NEXT	HEAT,	COOL,	MOD,	...
    ...
    {4, 1, 1, 4, 1, 3000, DELAY_LOW, 400, 0, 0,
     MOD_GPG40},  // WP_GPG40					// 39

    {4, 1, 1, 4, 1, 3000, DELAY_LOW, 400, 0, 0,
     MOD_M7},  // WP_M7					// 40
    {24, 1, 8, 24, 8, 1500, DELAY_PISTOL, 400, 0, 0,
     MOD_SILENCED_COLT},  // WP_SILENCED_COLT			// 41
    {24, 1, 8, 16, 8, 1500, 0, 400, 0, 0,
     MOD_GARAND_SCOPE},  // WP_GARAND_SCOPE			// 42
                         // GARAND
    {30, 1, 10, 20, 10, 2500, 0, 400, 0, 0,
     MOD_K43_SCOPE},  // WP_K43_SCOPE				// 43
                      // K43
    {60, 1, 20, 40, 20, 2000, DELAY_LOW, 400, 0, 0,
     MOD_FG42SCOPE},  // WP_FG42SCOPE				// 44
    {16, 1, 1, 12, 0, 0, 750, 1400, 0, 0,
     MOD_MORTAR},  // WP_MORTAR_SET			// 45
    {10, 1, 1, 0, 10, 1500, 50, 1000, 0, 0,
     MOD_SYRINGE},  // WP_MEDIC_ADRENALINE		// 46
    {48, 1, 8, 48, 8, 2700, DELAY_PISTOL, 200, 0, 0,
     MOD_AKIMBO_SILENCEDCOLT},  // WP_AKIMBO_SILENCEDCOLT	// 47
    {48, 1, 8, 48, 8, 2700, DELAY_PISTOL, 200, 0, 0,
     MOD_AKIMBO_SILENCEDLUGER},  // WP_AKIMBO_SILENCEDLUGER	// 48
    {450, 1, 150, 0, 150, 3000, DELAY_LOW, 66, 1500, 300,
     MOD_MOBILE_MG42},  // WP_MOBILE_MG42_SET		// 49
};
...
// new (10/18/00)
char* animStrings[] = {
    "BOTH_DEATH1",       "BOTH_DEAD1",        "BOTH_DEAD1_WATER",
    "BOTH_DEATH2",       "BOTH_DEAD2",        "BOTH_DEAD2_WATER",
    "BOTH_DEATH3",       "BOTH_DEAD3",        "BOTH_DEAD3_WATER",

    "BOTH_CLIMB",        "BOTH_CLIMB_DOWN",   "BOTH_CLIMB_DISMOUNT",

    "BOTH_SALUTE",

    "BOTH_PAIN1",        "BOTH_PAIN2",        "BOTH_PAIN3",
    "BOTH_PAIN4",        "BOTH_PAIN5",        "BOTH_PAIN6",
    "BOTH_PAIN7",        "BOTH_PAIN8",

    "BOTH_GRAB_GRENADE",

    "BOTH_ATTACK1",      "BOTH_ATTACK2",      "BOTH_ATTACK3",
    "BOTH_ATTACK4",      "BOTH_ATTACK5",

    "BOTH_EXTRA1",       "BOTH_EXTRA2",       "BOTH_EXTRA3",
    "BOTH_EXTRA4",       "BOTH_EXTRA5",       "BOTH_EXTRA6",
    "BOTH_EXTRA7",       "BOTH_EXTRA8",       "BOTH_EXTRA9",
    "BOTH_EXTRA10",      "BOTH_EXTRA11",      "BOTH_EXTRA12",
    "BOTH_EXTRA13",      "BOTH_EXTRA14",      "BOTH_EXTRA15",
    "BOTH_EXTRA16",      "BOTH_EXTRA17",      "BOTH_EXTRA18",
    "BOTH_EXTRA19",      "BOTH_EXTRA20",

    "TORSO_GESTURE",     "TORSO_GESTURE2",    "TORSO_GESTURE3",
    "TORSO_GESTURE4",

    "TORSO_DROP",

    "TORSO_RAISE",  // (low)
    "TORSO_ATTACK",      "TORSO_STAND",       "TORSO_STAND_ALT1",
    "TORSO_STAND_ALT2",  "TORSO_READY",       "TORSO_RELAX",

    "TORSO_RAISE2",  // (high)
    "TORSO_ATTACK2",     "TORSO_STAND2",      "TORSO_STAND2_ALT1",
    "TORSO_STAND2_ALT2", "TORSO_READY2",      "TORSO_RELAX2",

    "TORSO_RAISE3",  // (pistol)
    "TORSO_ATTACK3",     "TORSO_STAND3",      "TORSO_STAND3_ALT1",
    "TORSO_STAND3_ALT2", "TORSO_READY3",      "TORSO_RELAX3",

    "TORSO_RAISE4",  // (shoulder)
    "TORSO_ATTACK4",     "TORSO_STAND4",      "TORSO_STAND4_ALT1",
    "TORSO_STAND4_ALT2", "TORSO_READY4",      "TORSO_RELAX4",

    "TORSO_RAISE5",  // (throw)
    "TORSO_ATTACK5",     "TORSO_ATTACK5B",    "TORSO_STAND5",
    "TORSO_STAND5_ALT1", "TORSO_STAND5_ALT2", "TORSO_READY5",
    "TORSO_RELAX5",
    ...
    "TORSO_EXTRA",       "TORSO_EXTRA2",      "TORSO_EXTRA3",
    "TORSO_EXTRA4",      "TORSO_EXTRA5",      "TORSO_EXTRA6",
    "TORSO_EXTRA7",      "TORSO_EXTRA8",      "TORSO_EXTRA9",
    "TORSO_EXTRA10",

    "LEGS_WALKCR",       "LEGS_WALKCR_BACK",  "LEGS_WALK",
    "LEGS_RUN",          "LEGS_BACK",         "LEGS_SWIM",
    "LEGS_SWIM_IDLE",

    "LEGS_JUMP",         "LEGS_JUMPB",        "LEGS_LAND",
    ...
    "LEGS_EXTRA1",       "LEGS_EXTRA2",       "LEGS_EXTRA3",
    "LEGS_EXTRA4",       "LEGS_EXTRA5",       "LEGS_EXTRA6",
    "LEGS_EXTRA7",       "LEGS_EXTRA8",       "LEGS_EXTRA9",
    "LEGS_EXTRA10",
};
...
char* animStringsOld[] = {
    ...
    "BOTH_DEAD2",     "BOTH_DEATH3",      "BOTH_DEAD3",
    ...
    "TORSO_RAISE",  // (low)
    "TORSO_ATTACK",   "TORSO_STAND",      "TORSO_READY",
    "TORSO_RELAX",

    "TORSO_RAISE2",  // (high)
    "TORSO_ATTACK2",  "TORSO_STAND2",     "TORSO_READY2",
    "TORSO_RELAX2",

    "TORSO_RAISE3",  // (pistol)
    "TORSO_ATTACK3",  "TORSO_STAND3",     "TORSO_READY3",
    "TORSO_RELAX3",

    "TORSO_RAISE4",  // (shoulder)
    "TORSO_ATTACK4",  "TORSO_STAND4",     "TORSO_READY4",
    "TORSO_RELAX4",

    "TORSO_RAISE5",  // (throw)
    "TORSO_ATTACK5",  "TORSO_ATTACK5B",   "TORSO_STAND5",
    "TORSO_READY5",   "TORSO_RELAX5",
    ...
    "TORSO_EXTRA2",   "TORSO_EXTRA3",     "TORSO_EXTRA4",
    "TORSO_EXTRA5",
    ...
    "LEGS_IDLE",      "LEGS_IDLE2",       "LEGS_IDLECR",
...
gitem_t bg_itemlist[] = {
    ...
    */
    {
        ...
        {
            "models/powerups/health/health_t3.md3",  // just plate (should now
                                                     // be destructable)
    ...
    */
    {
        ...
        {
            "models/powerups/health/health_b3.md3",  // just plate (should now
                                                     // be destructable)
    ...
    */
    ...
    //launcher as such.  It's given implicitly 			by virtue of getting grenade
    //ammo.  So we don't need to have them in maps
    /*
    ...
    */
    {
        ...
        "models/multiplayer/dynamite/dynamite_3rd.md3",  // precache // JPW
                                                         // NERVE
        "",                                              // sounds
                                                         //		{0,0,0,0,0}
    },
...
/*gitem_t *BG_FindItemForKey(wkey_t k, int *indexreturn)
{
        ...
        for ( i = 0 ; i < bg_numItems ; i++ ) {
                if ( bg_itemlist[i].giType == IT_KEY && bg_itemlist[i].giTag ==
k ) {
                        {
                                if(indexreturn)
                                        *indexreturn = i;
...
=================================
BG_AddMagicAmmo:
        if numOfClips is 0, no ammo is added, it just return whether any ammo
CAN be added; otherwise return whether any ammo was ACTUALLY added.
...
qboolean BG_CanUseWeapon(int classNum, int teamNum, weapon_t weapon) {
  ...
  switch (classNum) {
    ...
    case PC_FIELDOPS:
      // TAT 1/11/2003 - in SP, field op can only use handgun, check after
      // switch below
    ...
    case PC_MEDIC:
      ...
      // TAT 1/11/2003 - in SP, medic can only use handgun, check after switch
      // below
  ...
  switch (item->giType) {
    case IT_WEAPON:
      if (item->giTag == WP_AMMO) {
        ...
        // xkan, 11/21/2002 - only pick up if ammo is not full, numClips is 0,
        // so ps will NOT be changed (I know, it places the burden on the
        // programmer, rather than the compiler, to ensure that).
        return BG_AddMagicAmmo((playerState_t*)ps, skill, teamNum,
                               0);  // Arnout: had to cast const away
      }
    ...
    case IT_HEALTH:
      ...
      if (ps->teamNum == PC_MEDIC) {
        // Gordon: medics can go up to 12% extra on max health as they have
        // perm. regen
...
void BG_CalculateSpline_r(splinePath_t* spline,
                          vec3_t out1,
                          vec3_t out2,
                          float tension) {
  vec3_t points[18];
...
qboolean BG_TraverseSpline(float* deltaTime, splinePath_t** pSpline) {
  ...
  while ((*deltaTime) > 1) {
    ...
    if (!(*pSpline)->next || !(*pSpline)->next->length) {
      return qfalse;
      //			Com_Error( ERR_DROP, "Spline path end passed
...
qboolean BG_RaySphereIntersection(float radius,
                                  vec3_t origin,
                                  splineSegment_t* path,
                                  float* t0,
                                  float* t1) {
  vec3_t v;
  float b, c, d;
...
void BG_LinearPathOrigin2(float radius,
  ...
  while (qtrue) {
    ...
    if (radius < 0) {
      if (!(*pSpline)->prev) {
        return;
        //				Com_Error( ERR_DROP, "End of spline
        //reached (%s)\n", start->point.name );
      }
      *pSpline = (*pSpline)->prev;
    } else {
...
void BG_EvaluateTrajectory(const trajectory_t* tr,
  ...
  switch (tr->trType) {
    ...
    case TR_SPLINE:
      ...
      /*		if(pSpline->isStart) {
                              deltaTime = 1 - sin((1 - deltaTime) * M_PI *
         0.5f); } else if(pSpline->isEnd) { deltaTime = sin(deltaTime * M_PI *
         0.5f);
                      }*/
...
void BG_GetMarkDir(const vec3_t dir, const vec3_t normal, vec3_t out) {
  ...
  if (VectorLengthSquared(normal) <
      SQR(1.f)) {  // this is needed to get rid of (0,0,0) normals (happens with
                   // entities?)
...
void BG_PlayerStateToEntityState(playerState_t* ps,
  ...
  if (ps->pm_type == PM_INTERMISSION ||
      ps->pm_type ==
          PM_SPECTATOR) {  // || ps->pm_flags & PMF_LIMBO ) { // JPW NERVE limbo
    ...
    if (*spline->strTarget) {
      for (j = 0; j < spline->numControls; j++) {
        ...
        if (!pnt) {
          ...
          // Gordon: Just changing to a warning for now, easier for region
          // compiles...
          continue;
...
int BG_MaxAmmoForWeapon(weapon_t weaponNum, int* skill) {
  switch (weaponNum) {
    ...
    case WP_GRENADE_LAUNCHER:
      ...
      GetAmmoTableData(weaponNum)->maxammo ); break; case WP_MORTAR: case
      WP_MORTAR_SET: if( skill[SK_HEAVY_WEAPONS] >= 1 ) return(
      GetAmmoTableData(weaponNum)->maxammo + 2 ); else return(
      GetAmmoTableData(weaponNum)->maxammo ); break;*/
    case WP_MEDIC_SYRINGE:
