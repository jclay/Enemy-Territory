...
// JK: er, several reasons: its less than half the size of a brute-force
// approach,
//							gives us a simple map to
//what we actually care about, and the 							fact that we dont want to go above (if at
//all possible) 32 bits
