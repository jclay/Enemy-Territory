...
/*
"Do not go where the path leads, rather go where there's no track and leave a
trail."
...
"a madman is just someone living in another reality which isn't shared among
many people"
*/
