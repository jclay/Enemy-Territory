...
// TAT 12/10/2002
//		If possible, find a seek cover spot marked as exposed that is a
//parent or child of the current seek cover spot
int BotGetAdjacentExposedCoverSpot(bot_state_t* bs);

// TAT 1/8/2003
//	Get the next cover spot towards the retreatTo entity - used when
//retreating
