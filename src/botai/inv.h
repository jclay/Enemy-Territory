...
// please leave these open up to 27 (INVENTORY_9MM) (and double check defines
// when merging) the inventory max (MAX_ITEMS) is 256, so we aren't too
// concerned about running out of space
...
// Mad Doc - TDF
// @TODO make an inventory for whatever we decide to use for BAR ammo. Bots
// can't use M1?

// please leave these open up to 48 (INVENTORY_HEALTH) (and double check defines
// when merging) the inventory max (MAX_ITEMS) is 256, so we aren't too
// concerned about running out of space
