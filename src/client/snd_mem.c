...
static waveFormat_t waveFormats[] = {{"Windows PCM", 1},
                                     {"Antex ADPCM", 14},
                                     {"Antex ADPCME", 33},
                                     {"Antex ADPCM", 40},
...
================
*/
static void ResampleSfx(sfx_t* sfx,
                        int inrate,
                        int inwidth,
                        byte* data,
                        qboolean compressed) {
...
================
*/
static int ResampleSfxRaw(short* sfx,
                          int inrate,
                          int inwidth,
                          int samples,
                          byte* data) {
...
void S_DisplayFreeMemory() {
  Com_Printf(
      "%d bytes (%.2fMB) free sound buffer memory, %d bytes (%.2fMB) total "
      "used\n%d bytes (%.2fMB) sound buffer memory have been allocated since "
      "the last SND_setup",
      inUse, inUse / Square(1024.f), totalInUse, totalInUse / Square(1024.f),
      totalAllocated, totalAllocated / Square(1024.f));
}
