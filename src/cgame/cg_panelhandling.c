...
void CG_PanelButton_RenderEdit(panel_button_t* button) {
  ...
  if (useCvar) {
    ...
    } while (CG_Text_Width_Ext(s + offset, button->font->scalex, 0,
                               button->font->font) > button->rect.w);

    CG_Text_Paint_Ext(button->rect.x, button->rect.y + button->rect.h,
                      button->font->scalex, button->font->scaley,
                      button->font->colour, s + offset, 0, 0,
                      button->font->style, button->font->font);
...
qboolean CG_PanelButtonsKeyEvent(int key,
                                 qboolean down,
...
void CG_PanelButtonsRender_Text(panel_button_t* button) {
  ...
  CG_Text_Paint_Ext(button->rect.x, button->rect.y, button->font->scalex,
                    button->font->scaley, button->font->colour, button->text, 0,
